...
export const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white via-orange-50/40 to-white text-slate-900 border-b border-orange-100 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {points.map((pt, idx) => (
            <ScrollReveal key={pt.num} animation="fade-up" delay={idx * 120}>
              <div className="bg-white p-8 rounded-2xl border border-orange-200/90 shadow-md hover:border-orange-500 hover:shadow-2xl transition-all duration-300 group relative flex flex-col justify-between h-full">
                <div className="space-y-4">
                  <span className="text-4xl font-extrabold text-orange-600 font-mono tracking-tighter block group-hover:scale-110 transition-transform origin-left">
                    {pt.num}
                  </span>
                ...
                <div className="mt-8 pt-4 border-t border-orange-100 flex items-center justify-between text-[10px] font-extrabold text-slate-500 uppercase tracking-wider">
